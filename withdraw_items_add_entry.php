                    ...
                    <div class='card-body'>
                        ...
                        <div style='display: flex; width:100%;  padding:10px;  background:white'>
                            ...
                            <div style='display:block'>
                                ...
                                <select onclick='s_office(this)' class='form-select' aria-label='Default select example' style='width:300px' id='office'>
                                    <option selected>Select office first</option>
                                    ";
                                    if(count($rows) > 0){
                                        foreach ($rows as $row){  
                                            $str = $str."<option value='".$row."'>".$row."</option>";
                                        }
                                    }
