...
<!----------------------------------------------------------------------->
    ...
    padding-top: 15px;'>".$_SESSION['accesstype']; } ?></span><a href="logout.php" class="btn logout-btn" >Logout</a>
            ...
            <a href="delivery_items.php">
                <h6 style="background-color:#118911;">Arrived Items</h6>
            </a>
            <a href="widthdraw_items.php">
                <h6 style="">Widthdraw Items</h6>
            </a>
        ...
        <div class="in-content"> 
            ...
            <div style='width:100%; '>
                <div style="padding:0 30px">
                    <h3 style="font-weight: 700; ">Arrived Items</h3>
                </div>
                <div class="e-cards" style="margin:20px 0; display:flex; ">
                    <div class="card" style="width: 100%;  margin: 0 20px;  border-radius: 19px;">
                        <div class="card-body" >
                            ...
                            <div style="margin:0 20px; display:flex">
                                ...
                                <div style="display:block; width:40%; margin-top:10px">
                                    <div>
                                        <h6><i class="fa-solid fa-paper-plane fa-xl"></i> Sent: 3043</h6>
                                    </div>
                                    <div>
                                        <h6><i class="fa-solid fa-stopwatch fa-xl"></i> Pending: 3409</h6>
                                    </div>
                                </div>
                    ...
                    <div class="card" style="width: 100%;  margin: 0 20px;  border-radius: 19px;">
                        <div class="card-body" >
                            <div style="margin:0px 20px 0 20px; display:flex">
                                <div style="width:100%">
                                    <h4 style="float:left; margin-top: 10px;">Arrived Items </h4>
                                    <i style="float:right; margin:30px 20px; font-size:40px" class="fa-solid fa-ballot-check fa-xl"></i>
                                </div>
                            </div>
                            <div style="margin:0 20px; display:flex">
                    ...
                    <div class="card" style="width: 100%;  margin: 0 20px;  border-radius: 19px;">
                        <div class="card-body" >
                            <div style="margin:0px 20px 0 20px; display:flex">
                                <div style="width:100%">
                                    <h4 style="float:left; margin-top: 10px;">Complete</h4>
                                    <i style="float:right; margin:30px 20px; font-size:40px" class="fa-solid fa-ballot-check fa-xl"></i>
                                </div>
                            </div>
                            <div style="margin:0 20px; display:flex">
                ...
                <!--
                <img src="loading.gif" id='load-gif' style="height:100px; width:100px; position:absolute; margin: 200px 0 0 40%; display:none">
