...
$vars = $userClass->widthdrawal_records();
...
<head>
    ...
    <!-- Add the SweetModal CSS file -->
<link rel="stylesheet" href="https://sweet-modal.adepto.as/dist/min/jquery.sweet-modal.min.css">

<!-- Add jQuery -->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>

<!-- Add the SweetModal JavaScript file -->
<script src="https://sweet-modal.adepto.as/dist/min/jquery.sweet-modal.min.js"></script>
...
<div class="tags">
    ...
    <a href="supply_records.php" style="">
        <h6>Supply Records</h6>
    </a>
    <a href="records_panel.php">
        <h6 style="background-color:#118911;">Widthdrawal Records</h6>
    </a>
</div>
        <div class="head">
                        ...
                        <thead class="table">
                                    ...
                                    foreach($vars as $var){
                                         ...
                                         ?><tr>
                                              ...
                                              <td ><?php echo $var['trans_num']; ?></td>
                                              <td ><?php echo $var['pon']; ?></td>
                                              <td ><?php echo $var['office']; ?></td>
                                              <td ><span style="display:flex;"><button class='btn btn-secondary' onClick='office_details(this)'>wiew</button></td>
                                            </tr>
                                            <?php 
                                            $i++;
                                            }
