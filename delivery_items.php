...
$vars= $userClass->getAllEntries('Arrived');
...
<div class="modal fade" id="summary" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document" >
              <div class="modal-content">
                ...
                <form action="" method="post" id ="modal-details" style="margin:20px">
        ...
        <div class="in-content"> 
            ...
            <div style='width:100%; padding:20px'>
                <div style="padding:0px">
                    <h3 style="font-weight: 700; ">ARRIVED  </h3>
                </div>
                <hr>
                <br>
                <div id="in-arr">
                    <div style="width:100%; padding: 10px 10px 10px 0; height:45px">
                        ...
                        <h4 style="float:left"> Recently Added</h4>
                        <button onclick="location.href='delivery_items_new_entry.php'"class="btn btn-primary" style="float:right" >New Entry</button>
