...
$str =  "<div style='display: flow-root; width:92%; display:flex; padding:10px; justify-content: space-between; background:white'>
<h6 id='pon_office' style='flex-basis: 30%;'>P.O.N: <span style='color:rgb(28, 126, 3);'>$pon</span></h6>  
<h6 style='flex-basis: 30%;'>Supplier: <span style='color:rgb(28, 126, 3);'>".$rows1[0]['supplier']."</span></h6>  
<h6 style='flex-basis: 30%;'>Date: <span style='color:rgb(28, 126, 3);'>".$rows1[0]['date']."</span></h6>   
</div>
<hr>
<div id='in_data_office'>
<div>
...
foreach($rows as $row){
        ...
        $str=$str."<tr>
          ...
          </button><button class='btn btn-secondary' id='office-items' value='".$row['pon']."' onClick='office_details(this)'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-eye' viewBox='0 0 16 16'>
