     ...
     <div class='containers'>
        ...
        <div class='in-content'> 
           ...
           <div style='width:95%; padding-left:30px ;height:50px'>
                <h3 style="font-weight: 700; float:left ; ">PURCHASED REQUEST RECORD<span><i class="fa-solid fa-angle-right"></i></span><span style="font-size:25px; font-weight:500"> Create Record</span></h3>
                    <button onclick="location.href='pon_items2.php'"class="btn btn-primary" style="float:right" >Back</button>
</div>
            ...
            <div style='margin:30px'>
                ...
                <div>
                    ...
                    <div class='progress' style='background:#fff'>
                        <div class='progress-bar bg-success progress-bar-striped progress-bar-animated' role='progressbar' aria-valuenow='75' style="width: 0%;"aria-valuemin='0' aria-valuemax='100'></div>
                    ...
                    <div id='result_pon' style='height: 600px;'>
                        <table class='table ttable' >
                            ...
                            if($vars==''){ 
                                ...
                                $i=1;
                                foreach($vars as $var){ 
                                    if($userClass->getPONRecordStat($var['pon'])==true){
                                   ?>
                                <tr class='tr_id' style = "background:#c3c3c3;" >
                                <?php } else{ ?>
                                     <tr class='tr_id' onclick='s_item(this)'>
                                     <?php }    ?>
                                    ...
                                    <td><?php if($userClass->getPONRecordStat($var['pon'])==true){
                                        echo "<span style='font-weight:700'>Recorded!</span>";
                                    } ?></td>
                                </tr>
                                <?php 
...
function procced_to_select_office(){
   ...
   if(s_item.length==0){
        alert("No item is selected! Please select item first.")
   }else{
...
$(".dropdown-menu").on('click', function(e) {
 ...
 //  console.log($(".dropdown-menu").html())
  $('.dropdown-item').find('input[type="checkbox"]').on('click', function() {http://localhost/sowms/pon_items.php
    var selectedItems = [];
